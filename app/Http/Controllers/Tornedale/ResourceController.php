...
namespace App\Http\Controllers\Tornedale;
...
class ResourceController extends Controller
{
  ...
  public function Less(){
        ...
        $css = app('App\Http\Controllers\Tornedale\ResourceController')->minify_css($parser->getCss());
        ...
        $compiled = app('App\Http\Controllers\Tornedale\ResourceController')->minify_css($compiled);
